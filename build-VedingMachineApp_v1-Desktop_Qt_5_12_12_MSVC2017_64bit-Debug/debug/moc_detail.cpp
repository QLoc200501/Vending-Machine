...
#include "../../VedingMachineApp_v1/detail.h"
...
QT_MOC_LITERAL(1, 7, 14), // "btn_oke_status"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 17), // "on_BTN_OK_clicked"
QT_MOC_LITERAL(4, 41, 21), // "on_BTN_cancel_clicked"
QT_MOC_LITERAL(5, 63, 13) // "btn_ok_change"

    },
    "detail\0btn_oke_status\0\0on_BTN_OK_clicked\0"
    "on_BTN_cancel_clicked\0btn_ok_change"
};
...
void detail::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<detail *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->btn_oke_status(); break;
        case 1: _t->on_BTN_OK_clicked(); break;
        case 2: _t->on_BTN_cancel_clicked(); break;
        case 3: _t->btn_ok_change(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (detail::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&detail::btn_oke_status)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject detail::staticMetaObject = { {
    ...
    qt_meta_stringdata_detail.data,
    qt_meta_data_detail,
    qt_static_metacall,
    nullptr,
    nullptr
